...
package RT::Condition::SLA_RequireReplySet;

use base qw(RT::Condition::SLA);

=head1 NAME

RT::Condition::SLA_RequireReplySet - checks if SLA Reply date require update

=head1 DESCRIPTION

Checks if SLA Reply date require update. This should be done when we create
